...
public class CursorAdapterActivity extends android.app.ListActivity implements LoaderManager.LoaderCallbacks<Cursor> {
  ...
  static final String SORT_ORDER = ContactsContract.Contacts.DISPLAY_NAME + " COLLATE LOCALIZED ASC";
  ...
  public Loader<Cursor> onCreateLoader(int id, Bundle args) {
    ...
    return new CursorLoader(this, ContactsContract.Data.CONTENT_URI, PROJECTION, SELECTION, null, SORT_ORDER);
  }
