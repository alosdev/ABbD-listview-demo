...
public class HeaderFooterActivity extends android.app.ListActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // Header & Footer must be set before adapter
    // attention header & Footer not fixed, and different positions
